    ...
    public class StudentsController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Students != null ? 
                          ...
                          Problem("Entity set 'ApplicationContext.Students'  is null.");
        }
        ...
        {
            ViewData["GroupId"] = new SelectList(_context.Groups, "Name", "Name");
        ...
        public async Task<IActionResult> Create([Bind("ID,Name,GroupId")] Student student)
        {
            ...
            ViewData["GroupId"] = new SelectList(_context.Groups, "Name", "Name", student.GroupId);
